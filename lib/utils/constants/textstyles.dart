...
final toptitleStyle = GoogleFonts.jost(
    textStyle: TextStyle(
        letterSpacing: 0.2,
        fontSize: 14.00.sp,
        color: toptitlecolor,
...
final product = GoogleFonts.jost(
    textStyle: TextStyle(
        wordSpacing: 2,
        letterSpacing: 0.2,
        fontSize: 10.00.sp,
...
final loginbuttonstyle = GoogleFonts.jost(
    textStyle: TextStyle(
        letterSpacing: 1.2,
        fontSize: 16.00.sp,
        color: Colors.white,
        fontWeight: FontWeight.w600));
final socialbutton = GoogleFonts.jost(
    textStyle: TextStyle(
        fontSize: 8.00.sp,
...
final sort = GoogleFonts.jost(
    textStyle: TextStyle(
        ...
        color: const Color(0xff000000),
        fontWeight: FontWeight.w600));
final viewmore = GoogleFonts.jost(
    textStyle: TextStyle(
        fontSize: 12.00.sp,
        color: const Color(0xff5EBDB7),
        fontWeight: FontWeight.w600));
final apptitle = GoogleFonts.jost(
    textStyle: TextStyle(
        fontSize: 15.00.sp,
        color: screenbackground,
        fontWeight: FontWeight.w600));
...
final menuprofiloption = GoogleFonts.jost(
    textStyle: TextStyle(
        ...
        fontWeight: FontWeight.w500));
final editprofilename = GoogleFonts.jost(
    textStyle: TextStyle(
        fontSize: 14.00.sp,
        color: const Color(0xff263238),
        fontWeight: FontWeight.w600));
final buttonprice = GoogleFonts.jost(
    textStyle: TextStyle(
        fontSize: 8.00.sp,
        color: screenbackground,
        fontWeight: FontWeight.w600));
final buttontext = GoogleFonts.jost(
    textStyle: TextStyle(
        fontSize: 12.00.sp,
        color: screenbackground,
        fontWeight: FontWeight.w600));
